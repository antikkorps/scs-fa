// @ts-nocheck
// Fichier de référence — workflows et fonctions métier à porter dans apps/api/src/services/
// Les imports ne résolvent pas (intentionnel) — ce fichier n'est ni typé ni exécuté.
// Source : prompt initial. Voir BACKLOG pour le portage feature par feature.

import { db } from "./client"
import { legalCategories, productCategories } from "./schema"
...
export async function seedDatabase() {
  ...
  const legalCatsData = [
    ...
    },
    {
      ...
      description: "Armes libres de port/détention (sprays défense, bâtons télescopiques, etc.)",
      requiresVerification: true,
      minAge: 18,
